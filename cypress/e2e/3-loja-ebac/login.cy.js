...
describe('Funcionalidade: Login', () => {
   ...
   it('Deve exibir uma mensagem de erro ao inserir senha inválida', () => {
     cy.get('#username').type('juniorodrigueslol578@gmail.com')
     cy.get('#password').type('opa*')
     cy.get('.woocommerce-form > .button').click()
     cy.get('.woocommerce-error').should('contain' , 'Erro: A senha fornecida para o e-mail juniorodrigueslol578@gmail.com está incorreta. Perdeu a senha?')
     cy.get('.woocommerce-error').should('exist')
   });
